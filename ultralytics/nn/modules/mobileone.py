...
class MobileOneBlockv5(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super(MobileOneBlockv5, self).__init__()
...
class MobileOnev5(nn.Module):
    ...
    def _make_stage(self,
        ...
        for ix, stride in enumerate(strides):
            ...
            # Depthwise conv
            blocks.append(MobileOneBlockv5(in_channels=self.in_planes,
